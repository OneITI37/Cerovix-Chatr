...
function (t, e) {
	...
	return function (t) {
		...
		function r(t, e) {
			...
			return l ? (c("ignoring socket cache for %s", s), n = a(s, e)) : (p[u] || (c("new io instance for %s", s), p[u] = a(s, e)), n = p[u]),
	...
	function (t, e, n) { (function (e) {
			function r(t, n) {
				...
				t ? (t = u(t), n.hostname = t.host, n.secure = "https" === t.protocol || "wss" === t.protocol, n.port = t.port, t.query && (n.query = t.query)) : n.host && (n.hostname = u(n.host).host),
	...
	function (t, e, n) {
		...
		r.prototype.uri = function () {
			...
			n = ""; ! 1 !== this.timestampRequests && (t[this.timestampParam] = c()),
	...
	function (t, e, n) {
		...
		(function (t, o) { !
			function (i) {
				...
				function a(t) {
					for (var e, n = t.length, r = -1, o = ""; ++r < n;) e = t[r],
				...
				function u(t, e) {
					...
					var n = "";
					return 0 == (4294965248 & t) ? n = w(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (c(t, e) || (t = 65533), n = w(t >> 12 & 15 | 224), n += p(t, 6)) : 0 == (4292870144 & t) && (n = w(t >> 18 & 7 | 240), n += p(t, 12), n += p(t, 6)),
					n += w(63 & t | 128)
				}
				function h(t, e) {
					e = e || {};
					for (var n, r = !1 !== e.strict, o = s(t), i = o.length, a = -1, c = ""; ++a < i;) n = o[a],
					c += u(n, r);
					return c
				}
				function f() {
