...
function initialRoutine() {
    ...
    if (lang == "en")
        document.title = "Chatting - Chatr";
    else if (lang == "ko")
        document.title = "채팅 - Chatr";
    else if (lang == "jp")
        document.title = "チャット - Chatr";
    ...
    for (i = 0; i < document.getElementsByClassName("display-frame").length; i++)
        document.getElementsByClassName("display-frame")[i].src = document.getElementsByClassName("display-frame")[i].src.replace("no-language", lang);
